        ...
        <div className="quickLinks">
          ...
          <div className="column">
            ...
            <ul className="list social-links">
              <li>
                <a href="https://github.com/Soumojitshome2023/nextjs-videocall-webapp" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                <a href="https://www.linkedin.com/in/soumojit-shome/" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
